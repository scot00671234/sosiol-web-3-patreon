...
A decentralized creator platform built on Solana, allowing fans to support creators with USDC tips and subscriptions.

## 🚀 Features

- **Wallet Integration**: Connect with Phantom, Slope, and other Solana wallets
- **USDC Payments**: Send tips and subscribe with USDC stablecoin
- **Creator Profiles**: Customizable profiles with avatars, bios, and subscription tiers
- **Subscription Tiers**: Multiple subscription levels for creators
...
4. Add subscription tiers with benefits
5. Share your creator page link
6. Track tips and subscribers in your dashboard
...
- `GET /api/subscriptions/creator/:walletAddress` - Get creator's subscribers
- `GET /api/subscriptions/fan/:walletAddress` - Get fan's subscriptions
- `GET /api/subscriptions/check/:fanWallet/:creatorWallet` - Check subscription status
