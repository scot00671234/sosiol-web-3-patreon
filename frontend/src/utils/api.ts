...
export const subscriptionAPI = {
  ...
  getByCreator: (walletAddress: string) => api.get(`/subscriptions/creator/${walletAddress}`),
  getByFan: (walletAddress: string) => api.get(`/subscriptions/fan/${walletAddress}`),
  check: (fanWallet: string, creatorWallet: string) => 
    api.get(`/subscriptions/check/${fanWallet}/${creatorWallet}`),
};
